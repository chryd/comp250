...
/*
 * Checks that every non-private method in finalproject.ChessSudoku is one of the required
 * methods
 */
...
/*
 * Checks that every non-private constructor in finalproject.ChessSudoku is one of the
...
/*
 * Checks that every non-private nested class in finalproject.ChessSudoku is one of the
...
public class Tester {
	...
	public static void checkAllSolutionsFound(ChessSudoku puzzle,
		...
		// finalproject.Main puzzle solved
